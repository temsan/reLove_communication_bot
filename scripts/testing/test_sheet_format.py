...
def test_sheet_creation():
    ...
    try:
        ...
        test_rows = [
            ['Дата', 'Название ритуала', 'ФИО', 'Разделение'],
            # ['Дата', 'Название ритуала', 'ФИО', 'Стадия пути героя', 'Разделение', 'Анализ'],
            ['15.11.2025', 'Кинкаку-дзи', 'Тестовый участник 1', 'Тестовое разделение 1'],
            ['15.11.2025', 'Кинкаку-дзи', 'Тестовый участник 2', 'Тестовое разделение 2'],
            ['15.11.2025', 'Кинкаку-дзи', 'Тестовый участник 3', 'Тестовое разделение 3'],
        ...
        # Обновляем количество колонок с 6 на 4
