...
- [x] 4. Обновить гибкую диагностику для использования SessionPersistenceService
...
- [x] 5. Создать ProfileRotationService
...
- [x] 5.2 Реализовать обновление профиля пользователя
...
- [x] 10.2 Реализовать обновление этапа
